...
let interests = ['Travel', 'Languages', 'Cultures', 'Cooking', 'Sewing', 'Writing'];
//console.log('\n' + 'My Interests:' + '\n' + '*' + me.interests[0] + '\n' + '*' + me.interests[1] + '\n' + '*' + me.interests[2] + '\n' + '*' + me.interests[3] + '\n' + '*' + me.interests[4] + '\n');
console.log('\n' + 'My Interests:')
...
let experience = ['Director of IT for Dickeys Barbecue Resturants, Inc.', 'Senior Business Analyst for RealPage, Inc.', 'IT Manager for Lincoln Property Company', 'IT Coordinator for Lincoln Property Company'];
